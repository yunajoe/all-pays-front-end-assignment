...
본 프로젝트는 데이터를 직관적으로 파악할 수 있는 대시보드 중심 UI를 의도하여 설계되었습니다.
사용자가 거래 흐름·성공률·가맹점 성과를 빠르게 인지할 수 있도록 차트 기반 시각화와 핵심 지표 위주의 구성으로 이루어져 있습니다.
또한 필터링, 검색, 정렬 등을 사용하여 사용자의 편의성에 맞는 UI/UX를 제공하려고 하였습니다.
